...
import v3 from 'uuid/dist/esm-browser/v3.js';
import v4 from 'uuid/dist/esm-browser/v4.js';
import v5 from 'uuid/dist/esm-browser/v5.js';
import v6 from 'uuid/dist/esm-browser/v6.js';
import v7 from 'uuid/dist/esm-browser/v7.js';
function usage() {
    console.log('Usage:');
    console.log('  uuid');
    console.log('  uuid v1');
